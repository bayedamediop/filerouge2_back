 ...
 */
final class Version20210303173730 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D649236A171E FOREIGN KEY (agance_id) REFERENCES agences (id)');
